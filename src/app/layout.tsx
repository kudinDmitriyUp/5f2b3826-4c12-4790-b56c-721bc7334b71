...
export const metadata: Metadata = {
  title: "Joule Ventures | Early Stage to Growth VC",
  description: "Strategic venture capital backing exceptional founders building the future. We provide capital, expertise, and network support across B2B SaaS, AI, fintech, and climate tech.",
  keywords: "venture capital, VC funding, startup investment, founders, Series A, Series B, tech investment",
  openGraph: {
    title: "Joule Ventures | Capital for Founders Building the Future",
    description: "Strategic venture capital backing exceptional founders with transformative ideas. We invest in early stage through growth companies.",
    type: "website",
    siteName: "Joule Ventures"
  },
  twitter: {
    card: "summary_large_image",
    title: "Joule Ventures | Capital for Founders",
    description: "Strategic venture capital backing exceptional founders building transformative companies."
  }
};
